...
<div class="wrapper" style="width: 500px;margin-top: 40px">
    ...
    <form class="layui-form" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="confirmPwd" lay-verify="required|pass" placeholder="确认密码"
                       autocomplete="off"
                       class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">长度为6-12位字母加数字</div>
...
<script>
    layui.use(['element', 'form', 'layer'], function () {
        ...
        form.on('submit(updateAdmin)', function (data) {
            ...
            $.post("${pageContext.request.contextPath}/admin/changePassword", data.field, function (res) {
                if (res === "OK") {
